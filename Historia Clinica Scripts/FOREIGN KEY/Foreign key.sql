...
ALTER TABLE "SNH_MST_ANTE_PATOLOGICOS" ADD CONSTRAINT "FRK_MST_HISTORIA_CLINICA_PAT" FOREIGN KEY ("HISTORIA_CLINICA_ID") REFERENCES "HOSPITALARIO"."SNH_MST_HISTORIA_CLINICA" ("HISTORIA_CLINICA_ID")
;
...
ALTER TABLE "HOSPITALARIO"."SNH_MST_ANTE_POSTNATALES" ADD CONSTRAINT "FRK_SBC_CAT_CATALOGOS_TIEMPO" FOREIGN KEY ("TIEMPO_MADRE") REFERENCES "CATALOGOS"."SBC_CAT_CATALOGOS" ("CATALOGO_ID");