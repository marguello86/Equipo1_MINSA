CREATE OR REPLACE PACKAGE BODY HOSPITALARIO.PKG_SNH_HISTORIA_CLINICA_CP
AS
    /****************************************************************************************************************************************************************************/
    ...
    existeRegistro NUMBER(1);
        ...
        BEGIN   
         ...
         --IF cursorLectura%ROWCOUNT > 0 THEN 
  ...
  WHEN OTHERS THEN
   ...
   PROCEDURE SNH_C_DET_SOCIOECONOMICO (
    ...
    AS
         --type r_antecedente is RECORD (numeroPregunta NUMBER(19), numeroSeccion NUMBER(19), preguntaId NUMBER(19), preguntaTexto VARCHAR(300), respuestaId NUMBER(19), respuesta VARCHAR(300));
    ...
    INSERT INTO HOSPITALARIO.SNH_MST_ANTE_SOCIOECONOMICO (
        ...
        --open var_cursor  for
        --select antecedenteid
        
      /* SELECT d.*, pAntecedente AS Antecedente
       FROM JSON_TABLE (pJsonData ,'$'
                        COLUMNS (
                        NESTED PATH '$.paredes[*]' COLUMNS (
             pTipoAntecedente NUMBER PATH '$.id' 
                            ), 
                             NESTED PATH '$.piso[*]' COLUMNS (
             pAntecedenteId NUMBER PATH '$.id' )
                          )) d ;
